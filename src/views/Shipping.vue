            ...
            <div class="flex justify-center w-full  border-gray-100  " v-for="product in productCart" :key="product">
              <div class=" font-semibold text-gray-600  uppercase w-2/5 " v-for="pro in product.orderDetails" :key="pro">
                <div class="flex justify-start items-center flex-row"  >
                  <img src="https://cdn-image02.casetify.com/usr/17130/1187130/~v87/4974841x2_iphone11_16002941.png.1000x1000-w.m80.jpg" alt="" class="h-16" />
                  ...
                  <div class="flex flex-col">
                    ...
                    <a @click="deleteCase(pro.productColorToProducts.products.caseID)"  href="#" class="font-semibold hover:text-red-500 text-gray-500 ">Remove</a>
                  </div>
                </div>
              </div>
              ...
              <div class="flex justify-center font-semibold text-gray-600  uppercase w-1/5"> <h2 >1550THB</h2></div>
              <div class="flex justify-center font-semibold text-gray-600 uppercase w-1/5"> <h2 >1550THB</h2></div>
            </div>
            
            <div class=" flex justify-end mr-20 ">
              <button type="button" class="text-center uppercase font-semibold rounded-3xl text-2xl p-5 h-16 w-42">3100THB</button>
          </div>
