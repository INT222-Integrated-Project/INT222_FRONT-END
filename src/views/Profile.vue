<template>
    ...
    <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
      <div class="lg:w-1/2 xl:w-5/12 p-3 sm:p-12">
        ...
        <div>
            <p class="text-black text-3xl text-center">{{user}}</p>
            <p class="text-black text-3xl text-center">{{firstName}}</p>
        </div>

        <form @submit.prevent="dosubmit">
       
          <input v-model="fname" id="fname" class="input-text" />
          <input type="submit" class="input-text" > 
