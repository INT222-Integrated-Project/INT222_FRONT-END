  ...
  <div class="bg-pink-100 min-h-screen">
    ...
    <div class="flex items-center" style="font-family: 'Muli', sans-serif">
      <div
        ...
        "
      >
        <div  class=" bg-white w-72 mb-3 rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
          
          <div class="rounded-lg p-3 bg-purple-400 flex flex-col h-32">
            <div>
              
              <span class="text-xs text-white leading-none">
                {{ this.showProfile.userName}}</span>
            </div>
      ...
      axios
        ...
        .then((response) => {
          this.showProfile = response.data;
           console.log("Profile : " + this.showProfile.userName);
           console.log("email : " + this.showProfile.email);
